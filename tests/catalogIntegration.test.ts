...
const demo: CatalogProduct[] = [
  { slug: 'epsilon',             name: 'Epsilon Series',           code: 'EPS-PE-001', categorySlug: 'compression-fittings', sectors: ['agriculture','landscape'],            material: 'POM body / EPDM seal',                       dnRange: [20, 110],  pnRating: 16, standards: ['ISO 17885','WRAS','KIWA'], imageUrls: [], image: '', blurb: '', pressure: '16 bar',  sizeRange: 'Ø20–Ø110',  bim: true,  specs: [], featured: true,  availableCountries: ['country-1','country-2'] },
  { slug: 'adaptor-flanged',     name: 'Adaptor Flanged Set',      code: 'NO330D',     categorySlug: 'hydraulic-fittings',   sectors: ['building','industry'],                material: 'PVC-U flange / EPDM gasket',                 dnRange: [50, 160],  pnRating: 16, standards: ['EN 1452','DIN 8061'],      imageUrls: [], image: '', blurb: '', pressure: '',        sizeRange: '',          bim: false, specs: [], featured: false, availableCountries: ['country-2'] },
  { slug: 'coupling-repair',     name: 'Coupling Repair',          code: 'NO331B',     categorySlug: 'compression-fittings', sectors: ['agriculture','building'],             material: 'PP body / EPDM seal',                        dnRange: [20, 110],  pnRating: 16, standards: ['ISO 14236'],               imageUrls: [], image: '', blurb: '', pressure: '',        sizeRange: '',          bim: false, specs: [], featured: false, availableCountries: ['country-1'] },
  { slug: 'coupling-transition', name: 'Coupling Global Transition', code: 'NO321D',  categorySlug: 'compression-fittings', sectors: ['agriculture','landscape','building'], material: 'PP body / brass insert / EPDM seal',         dnRange: [20, 63],   pnRating: 16, standards: ['ISO 14236'],               imageUrls: [], image: '', blurb: '', pressure: '',        sizeRange: '',          bim: false, specs: [], featured: false, availableCountries: ['country-2'] },
  { slug: 'single-4-bolts',      name: 'Single 4-bolts Flange',    code: 'NO550V',     categorySlug: 'hydraulic-fittings',   sectors: ['building','industry'],                material: 'Ductile iron flange / EPDM gasket / steel bolts', dnRange: [110, 315], pnRating: 10, standards: ['EN 1092-1'],            imageUrls: [], image: '', blurb: '', pressure: '',        sizeRange: '',          bim: false, specs: [], featured: false, availableCountries: ['country-2','country-3'] },
  { slug: 'double-union-glued',  name: 'Double Union Glued',       code: 'NO108F',     categorySlug: 'valves',               sectors: ['building','industry'],                material: 'PVC-U body / EPDM o-rings',                  dnRange: [20, 63],   pnRating: 16, standards: ['EN 1452'],                 imageUrls: [], image: '', blurb: '', pressure: '',        sizeRange: '',          bim: false, specs: [], featured: false, availableCountries: ['country-1'] },
  { slug: 'pvc-ball-valve',      name: 'PVC Ball Valve',           code: 'PVC-BV-50',  categorySlug: 'valves',               sectors: ['building','landscape'],               material: 'PVC-U body / PTFE seat / EPDM o-ring',       dnRange: [20, 110],  pnRating: 16, standards: ['EN 1452','DIN 8061'],      imageUrls: [], image: '', blurb: '', pressure: '',        sizeRange: '',          bim: false, specs: [], featured: false, availableCountries: ['country-1','country-3'] },
  { slug: 'saddle-clamp',        name: 'Saddle Clamp',             code: 'SDL-CL-32',  categorySlug: 'saddles',              sectors: ['agriculture','landscape','industry'], material: 'PP saddle / EPDM gasket / stainless bolts',  dnRange: [63, 315],  pnRating: 16, standards: ['ISO 8085'],                imageUrls: [], image: '', blurb: '', pressure: '',        sizeRange: '',          bim: false, specs: [], featured: false, availableCountries: ['country-1','country-3'] }
];
